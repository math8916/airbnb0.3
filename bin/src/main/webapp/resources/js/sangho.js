var booking = (function() {
	...
	var onCreate = function() {
			...
			$('#card_number').keyup(function(e) {
				if((e.which >=48 && e.which <= 57) || (e.which >=96 && e.which <= 105) || e.which==189 || e.which==8 || e.which==109){
					...
					if(cardNum.length > 18){
						if(util.card_num_checker($(this).val())){
		...
		$('#pub_artcle').on('click','#bt_paying',function(e){
			e.preventDefault();
		});
...
var PAYING_FORM = 
	'  <link href="https://a1.muscache.com/airbnb/static/packages/common_o2.1-50a45a2f41dab81f98765e60188dc94c.css" media="all" rel="stylesheet" type="text/css" />'
	+'<main id="site-content" role="main" style="margin-top : 10%;">'
...
+'<input type="text" id="card_number" maxlength="19" name="credit-card-number" data-hook="credit-card-number" class="first-message-input invalid">'
+'</div>'
...
+'<label for="credit-card-month" data-i18n="expires_on" class="text-lead">'
+'유효기간'
+'</label>'
+'<div class="row row-super-condensed">'
+'<div class="col-6">'
+'<div class="select select-block first-message-select-div">'
+'<select name="credit-card-month" data-hook="credit-card-month" class="first-message-input">'
+'<option>MM</option>'
...
+'<div class="col-6">'
+'<div class="select select-block first-message-select-div">'
+'<select name="credit-card-year" data-hook="credit-card-year" class="first-message-input">'
+'<option>YYYY</option>'
...
+'</div>'
+'</div>'
+'<div class="label label-warning inline-error hide text-lead" name="credit-card-exp-date-past-error" data-hook="exp-date-past-error" data-i18n="cc_expiration_past">'
+'</div>'
+'<div class="label label-warning inline-error hide text-lead" name="credit-card-exp-date-error" data-hook="credit-card-exp-date-error" data-i18n="cc_expiration_required">'
+'</div>'
+'</div>'
+'<div class="responsive-component col-6 cc-security-code">'
+'<label id="cvv-label" for="credit-card-cvv" data-i18n="security_code" class="text-lead">'
+'보안 코드'
+'</label>'
+'<div class="right-addon first-message-right-addon">'
+'<input type="text" name="credit-card-cvv" data-hook="credit-card-cvv" class="first-message-input">'
+'</div>'
+'<div class="label label-warning inline-error hide text-lead" name="credit-card-cvv-error" data-hook="credit-card-cvv-error" data-i18n="cc_security_code_required">'
+'</div>'
+'</div>'
+'</div>'
+'</div>'
...
+'<button class="btn btn-large btn-primary disabled" id="bt_paying"><span>요청 보내기</span></button>'
+'</div>'
+'</div>'
+'<div class="hide">'
+'<div class="space-1">'
